  ...
  <div class="form-container">
    ...
    <form @submit.prevent="saveContract">
      ...
      <div class="form-group">
        ...
        <input type="date" id="signedDate" v-model="contract.signed_date" required>
      </div>
      <div class="form-group">
        <label for="validUntil">Valid Until:</label>
        <input type="date" id="validUntil" v-model="contract.valid_until" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <p v-if="contract.file_path">Current File: <a :href="getFileUrl(contract.file_path)" target="_blank">Download PDF</a></p>
      </div>
      <div class="form-group">
        <button type="submit">{{ contractId ? 'Update' : 'Save' }} Contract</button>

        <button type="button" class="delete-button" @click="deleteContract" v-if="contractId">Delete Contract</button>
